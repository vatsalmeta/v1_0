...
void FRuntimeFilesDownloaderEditorModule::StartupModule()
{
	// This is required to access the external storage and record audio on Android
	{
		...
		TArray<FString> RequiredExtraPermissions = {"android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE", "android.permission.READ_MEDIA_AUDIO", "android.permission.READ_MEDIA_VIDEO", "android.permission.READ_MEDIA_IMAGES"};
